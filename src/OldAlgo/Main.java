...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        BitMatrix adjMatrix = AdjMatrix.readAdj("input5"); //OldAlgo.Util.AdjMatrix.makeRandom(14);
        BitMatrix adjMatrixPerm = AdjMatrix.readAdj("input6"); //OldAlgo.Util.AdjMatrix.makeRandom(14);
