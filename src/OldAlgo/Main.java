...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        BitMatrix adjMatrix = AdjMatrix.readAdj("input10.2"); //OldAlgo.Util.AdjMatrix.makeRandom(14);
        BitMatrix adjMatrixPerm = AdjMatrix.readAdj("input10.1"); //OldAlgo.Util.AdjMatrix.makeRandom(14);
